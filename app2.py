...
def main():
    ...
    if (st.session_state.ticketN and st.session_state.ticketN[0] == "1"):
        inventoryPage()
    elif st.session_state.ticketN:
        techPage()
    else:
        if params and 'Inventory' in params and params['Inventory']:
            st.session_state.ticketN = "1"+params['Inventory'][0]
            st.experimental_rerun()
        elif st.session_state.ticketN is None and params and params['TicketID']:
